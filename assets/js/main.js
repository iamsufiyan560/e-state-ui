$(function () {
  ...
  let navigationMenu = () => {
    let toggle = navigation.find(".menu-toggle"),
      ...
      navigationAnimateElement = menuWrapper.find(
    ...
    let init = () => {
      $(subMenus).each(function () {
        $(this).prepend(
          '<span class="menu-item back-link"><a href="#"><p><i class="fa fa-angle-left"></i></p> go back </a></span>'
        );
      });
      ...
      $(menuList.children()).each(function () {
        imageWrapper.append(
          '<div class="image-background" style="background-image: url(' +
            $(this).data("navigation-overlay-image") +
            ')"></div>'
        );
    ...
    let showItems = (showItems, delay, onCompleteFunc) => {
      ...
      showMenu = function () {
        TweenMax.to(navigationOverlay.children(), 0.7, {
          ...
          onComplete: () => {
            ...
            showItems(
              menuWrapper.find(".active-list").children().children("a"),
              0.7
            );
            menuWrapper
              .addClass("animate-element")
              .removeClass("animate-element-hide");
      ...
      hideMenu = function () {
        ...
        menuWrapper
          .addClass("animate-element-hide")
          .removeClass("animate-element");
      };
    ...
    menuList
      ...
      .on("click", function () {
        ...
        let showItemsCallback = () => {
          ...
          showItems(
            $(this).parent().children(".sub-menu").children().children("a"),
            0.2
          );
        };
        hideItems(
          $(this).parent().parent().children().children("a"),
          showItemsCallback
        );
      });
    ...
    subMenus.children(".back-link").on("click", function () {
      let showItemsCallback = () => {
        ...
        showItems(
          $(this).parent().parent().parent().children().children("a"),
          0.2
        );
      };
